...
#right_video { width: 500px; height: 1200px; float: right; background: url(http://www.them.net/sites/all/themes/themnet/images/stickpacks_video_background.jpg) bottom right no-repeat; }
...
<div id="logo3"><a href="<?php print $front_page; ?>" rel="home" id="logo">
            <img src="sites/all/themes/themnet/images/NewLogo.jpg" alt="<?php print t('Home'); ?>" />
          </a> </div><!-- /logoC -->   
  	  	<div id="nav3">  
...
<!-- /middle3 -->
<div id="right_video"><div class="video_container"><iframe src="http://player.vimeo.com/video/26119767?title=0&amp;byline=0&amp;portrait=0" width="435" height="326" frameborder="0"></iframe></div><?php print $right; ?></div>
<br class="clearboth" />
<!-- begin bottom -->
<div id="bottom">
