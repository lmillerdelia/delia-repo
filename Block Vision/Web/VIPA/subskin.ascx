...
<script type="text/javascript" src="/Portals/_default/Skins/VIPA/js/textsize.js" ></script>
...
<div class="footer">
    <div class="fullcontainer footercontainer">
    	<div class="copyright">
    		<p>&copy; Copyright 2011 Vision Insurance Plan of America, Inc. | Privacy Policy</p>
    	</div>
    </div>
</div>